export const soloWomen = (
    <div className="categories-definition">
...
export const teamOpen = (
    <div className="categories-definition">
        ...
        <p>Tyto kombinace mohou být napříč všemi hmotnostními i věkovými skupinami. Výsledné pořadí všech týmů v rámci kategorie Team Open je určeno seřazením hodnot Sinclairových bodů týmů. Sinclairovy body celého týmu jsou výsledkem součtů všech SB každého člena daného týmu.</p></div>
)
